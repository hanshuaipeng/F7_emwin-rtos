...
__align(32) uint8_t mem2base[MEM2_MAX_SIZE] __attribute__((at(0XC0600000)));					//外部SDRAM内存池,前面2M给LTDC用了(1280*800*2)
...
uint32_t mem2mapbase[MEM2_ALLOC_TABLE_SIZE] __attribute__((at(0XC0600000+MEM2_MAX_SIZE)));	//外部SRAM内存池MAP
