...
//英文键盘按键参数
#define ENG_BUTTON_WIDTH			23	//英文键盘按钮宽度
#define ENG_BUTTON_HEIGHT			42	//英文键盘按钮的高度
#define ENG_BUTTON_XPAC				3	//英文键盘按钮X轴间距

#define ENG_BUTTON_LINE1YPOS		4	//英文键盘第一行Y坐标
#define ENG_BUTTON_LINE2YPOS		51	//英文键盘第二行Y坐标
#define ENG_BUTTON_LINE3YPOS		97	//英文键盘第三行Y坐标
#define ENG_BUTTON_LINE4YPOS		144	//英文键盘第四行Y坐标

#define ENG_BUTTONLINE1_XOFFSET		4	//英文键盘第一行按钮X轴偏移
#define ENG_BUTTONLINE2_XOFFSET		18	//英文键盘第二行按钮X轴偏移
#define ENG_BUTTONLINE3_XOFFSET		4	//英文键盘第三行按钮X轴偏移
#define ENG_BUTTONLINE4_XOFFSET		4	//英文键盘第四行按钮X轴偏移

#define ENG_BUTTONSHIFT_XINC		15	//英文键盘shift键的X轴长度增量
#define ENG_BUTTONENTER_XINC		15	//英文键盘回车键的X轴长度增量
#define ENG_BUTTONFIGURE_XINC		15	//英文键盘数字键的X轴长度增量
#define ENG_BUTTONSYMBOL_XINC		15	//英文键盘符号键的X轴长度增量
#define ENG_BUTTONSPACE_XINC		27	//英文键盘空格键的X轴长度增量
#define ENG_BUTTONCE_XINC			15	//英文键盘中英文切换按键的X轴长度增量
#define ENG_BUTTONBACK_XINC			15	//英文键盘删除键的X轴长度增量

//数字键盘按键参数
#define NUM_BUTTON_WIDTH			63	//数字键盘按钮宽度
#define NUM_BUTTON_HEIGHT			43	//数字键盘按钮高度
#define NUM_BUTTON_XPAC				3	//数字键盘按钮X轴间距
#define NUM_BUTTON_XOFFSET			4	//数字键盘每行按钮X轴偏移

#define NUM_BUTTON_LINE1YPOS		4	//数字键盘第一行Y坐标
#define NUM_BUTTON_LINE2YPOS		51	//数字键盘第二行Y坐标
#define NUM_BUTTON_LINE3YPOS		97	//数字键盘第三行Y坐标
#define NUM_BUTTON_LINE4YPOS		144	//数字键盘第四行Y坐标

#define NUM_BUTTONSING_XINC			42	//数字键盘中符号的X轴长度增量
#define NUM_BUTTONBACKSPACE_XINC	25	//数字键盘中删除键的X轴长度增量
#define NUM_BUTTONSPACE_XINC		25	//数字键盘中空格键的X轴长度增量
#define NUM_BUTTONENTER_XINC		25	//数字键盘中回车键的X轴长度增量
#define NUM_BUTTONRETURN_XINC		25	//数字键盘中返回键的X轴长度增量

//符号键盘按键参数
#define SING_BUTTON_WIDTH			53	//符号键盘按钮宽度
#define SIGN_BUTTON_HEIGHT			42	//符号键盘按钮高度
#define SIGN_BUTTON_XPAC			3	//符号键盘按钮X轴间距
#define SIGN_BUTTON_XOFFSET			4	//符号键盘每行按钮X轴偏移
#define SIGN_BUTTONCONTR_XINC		16	//符号键盘中控制按键的X轴长度增量

#define SIGN_BUTTON_LINE1YPOS		4	//符号键盘第一行Y坐标
#define SIGN_BUTTON_LINE2YPOS		51	//符号键盘第二行Y坐标
#define SIGN_BUTTON_LINE3YPOS		97	//符号键盘第三行Y坐标
#define SIGN_BUTTON_LINE4YPOS		144	//符号键盘第四行Y坐标

//中文键盘按键参数1
#define CHIN1_BUTTON_WIDTH			50	//中文键盘1按钮宽度
#define CHIN1_BUTTON_HEIGHT			48	//中文键盘1按钮高度
#define CHIN1_BUTTON_XPAC			2	//中文键盘1按钮X轴间距
#define CHIN1_BUTTON_XOFFSET	    66	//中文键盘1每行按钮X轴偏移
#define CHIN1_BUTTONCONTR_XINC		8	//中文键盘1中控制按键的X轴长度增量

#define CHIN1_BUTTON_LINE1YPOS		33	//中文键盘1第一行Y坐标
#define CHIN1_BUTTON_LINE2YPOS		86	//中文键盘1第二行Y坐标
#define CHIN1_BUTTON_LINE3YPOS		139	//中文键盘1第三行Y坐标

//中文键盘按键参数2
#define CHIN2_BUTTON_WIDTH			34	//中文键盘2按钮宽度
#define CHIN2_BUTTON_HEIGHT			30	//中文键盘2按钮高度
...
#define CHIN2_BUTTONPY_YINC         2   //中文键盘2中控制按键的Y轴长度增量

#define CHIN2_BUTTON_LINE1YPOS		0	//中文键盘2第一行Y坐标
#define CHIN2_BUTTON_LINE2YPOS		30	//中文键盘2第二行Y坐标
#define CHIN2_BUTTON_LINE3YPOS		62	//中文键盘2第三行Y坐标
#define CHIN2_BUTTON_LINE4YPOS		95	//中文键盘2第四行Y坐标
#define CHIN2_BUTTON_LINE5YPOS		127	//中文键盘2第五行Y坐标
#define CHIN2_BUTTON_LINE6YPOS		160	//中文键盘2第五行Y坐标
